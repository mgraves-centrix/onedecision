...
> Teach the agent once; it safely handles the next hundred decisions. An AI agent learns
> from one approved call, proves the rule on past cases, and hands anything unfamiliar to
> a person.
